 ...
 * Using the ```-v``` flag, the tests can ba hardened to only evaluate to positivie, if state changes of write requests can be confirmend by subsequent read requests. See [Usage Section](#usage) 
